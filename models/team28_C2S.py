...
class TimeDiffiT_ResNet_color(nn.Module):
    def __init__(
        self,
        dim,
        init_dim = 64,
        ...
        dims = [64, *map(lambda m: 64 * m, dim_mults)]
        ...
        FullAttention = partial(TimeAttention, flash = flash_attn)
        ...
        self.final_res_block = block_klass(64 * 2, 64, time_emb_dim = 256)
        # self.final_res_block = block_klass(64, 64, time_emb_dim = 256) # if not using top-level skip connection
